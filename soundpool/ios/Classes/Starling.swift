...
public typealias SoundIdentifier = Int

/// Errors specific to Starling's loading or playback functions
enum StarlingError: Error {
    case invalidSoundIdentifier(name: SoundIdentifier)
...
public class Starling {
 ...
 // MARK: - Internal Properties
    ...
    private var files: [SoundIdentifier: AVAudioFile]
    ...
    public init() {
        ...
        files = [SoundIdentifier: AVAudioFile]()
    ...
    public func load(sound url: URL) -> Int {
        if let file = try? AVAudioFile(forReading: url) {
            let identifier = files.keys.count
    ...
    private func performSoundStop(_ sound: SoundIdentifier)  {
        objc_sync_enter(players)
